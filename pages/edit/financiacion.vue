                    ...
                    <UAccordion default-open multiple variant="soft" size="xl" :items="financiero1">
                        <template #visa-master-nativa v-if="data_visamasternativa">
                            <div class="text-sea-green-900 dark:text-white text-center">
                                ...
                                <DataTable :value="data_visamasternativa" editMode="row"
                                    v-model:editingRows="editingRows" dataKey="id" @row-edit-save="onRowEditSave1" :pt="{
                                        table: { class: 'w-full' },
                                    ...
                                    <Column style="width: 5%;" bodyStyle="text-align:left">
                                        <template #body="{ data }">
                                            <UButton class="flex-none" icon="i-heroicons-trash-solid" size="sm"
                                                ...
                                                @click="removeIdVisaMasterNativa(data.id)"></UButton>
                                        </template>
                                    </Column>
                                </DataTable>
                            </div>
                    ...
                    <UAccordion default-open multiple variant="soft" size="xl" :items="financiero2">
                        <template #naranja v-if="data_naranja">
                            <div class="text-sea-green-900 dark:text-white">
                                ...
                                <DataTable :value="data_naranja" editMode="row" v-model:editingRows="editingRows2"
                                    dataKey="id" @row-edit-save="onRowEditSave2" :pt="{
                                        table: { class: 'w-full' },
                                        columnHeaderContent: { class: '!text-gray-500 dark:!text-gray-400' },
                                        headerrow: { class: 'border-solid border-b border-sea-green-300 dark:border-sea-green' },
                                        bodyrow: { class: 'border-solid border-t border-gray-300 dark:border-gray-700 text-gray-500 dark:text-gray-400' },
                                    ...
                                    <Column style="width: 5%;" bodyStyle="text-align:left">
                                        <template #body="{ data }">
                                            <UButton class="flex-none" icon="i-heroicons-trash-solid" size="sm"
                                                variant="link" color="red" squre @click="removeIdNaranja(data.id)">
                                            </UButton>
                                        </template>
                                    </Column>
                                </DataTable>
                    ...
                    <UAccordion default-open multiple variant="soft" size="xl" :items="financiero3">
                        <template #cuota-simple v-if="data_cuotasimple">
                            <div class="text-sea-green-900 dark:text-white text-center">
                                ...
                                <DataTable :value="data_cuotasimple" editMode="row" v-model:editingRows="editingRows3"
                                    dataKey="id" @row-edit-save="onRowEditSave3" :pt="{
                                        table: { class: 'w-full' },
                                        columnHeaderContent: { class: '!text-gray-500 dark:!text-gray-400' },
                                        headerrow: { class: 'border-solid border-b border-sea-green-300 dark:border-sea-green' },
                                        bodyrow: { class: 'border-solid border-t border-gray-300 dark:border-gray-700 text-gray-500 dark:text-gray-400' },
                                    ...
                                    <Column style="width: 5%;" bodyStyle="text-align:left">
                                        <template #body="{ data }">
                                            <UButton class="flex-none" icon="i-heroicons-trash-solid" size="sm"
                                                variant="link" color="red" squre @click="removeIdCuotaSimple(data.id)">
                                            </UButton>
                                        </template>
                                    </Column>
                                </DataTable>
...
definePageMeta({
    title: 'Editar el costo de financiación - Simulador de cobranzas',
