  ...
  <div>
    <UContainer :ui="{ constrained: 'max-w-screen-2xl' }">
      ...
      <div class="flex justify-center">
        <UInput :ui="{ base: 'appearance-none m-0', rounded: 'rounded-lg', form: 'form-input' }" size="xl"
          icon="clarity:dollar-line" class="mb-8 max-w-2xl" placeholder="Ingresar monto c/IVA" v-model="monto"
          v-maska="optionsMask">
          <template #trailing>
            ...
            <UTabs :items="itemsTabs">
              <template #npc-npg="{ item }">
                <div class="grid grid-cols-2 w-auto h-auto rounded-md gap-4 items-center">
                  ...
                  <div class=" rounded-md p-2 text-xl text-center bg-amber-500"
                    @click="toast.add({ title: 'Copiado!' }); copy(cabacera)">
      ...
      <div class="tab">
        <template v-if="formData.monto">
          <UButton @click="addMore" icon="i-material-symbols-add-circle" size="md" square variant="soft" class="mb-4">
            Agregar</UButton>
